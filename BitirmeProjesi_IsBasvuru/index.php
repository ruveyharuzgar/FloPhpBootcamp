...
<body style="background-color: #FAB100;">
    ...
    <div class="flex-grow-4 me-3">

        <a href="./yonetim/cikis.php" onclick="if (!confirm('Çıkış Yapmak İstediğinizden emin misiniz?')) return false;" class="fw-bolder text-white-800 text-hover-primary fs-6 btn btn danger" style="float:right; background-color: #9A58AD; color: aliceblue;">Çıkış</a>
    ...
    echo '
        ...
        <div class="card card-xl-stretch mb-7 mb-xl-6" >
            <div class="card-header border-0 pt-10">
                ...
                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="csv format download">
                <div class="d-flex flex-shrink-10">
                ...
                <form  action="ara.php" method="GET" data-kt-search-element="form" class="w-100 position-relative mb-5 mb-lg-0" autocomplete="off" >
															...
															<span class="position-absolute top-50 end-10 translate-middle-y lh-0 d-none me-5" data-kt-search-element="spinner">
																<span class="spinner-border h-15px w-15px align-middle text-gray-400"></span>
															</span>

															<span class="btn btn-flush btn-active-color-primary position-absolute top-30 end-0 translate-middle-y lh-0 d-none me-4" data-kt-search-element="clear">
																<span class="svg-icon svg-icon-2 svg-icon-lg-1 me-0">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																		<rect opacity="0.5" x="6" y="17.3137" width="12" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="black" />
