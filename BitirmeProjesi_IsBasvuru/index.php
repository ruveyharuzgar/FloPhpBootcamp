...
<body>
    ...
    <div class="flex-grow-4 me-3">
        ...
        <a href="./yonetim/cikis.php" onclick="if (!confirm('Çıkış Yapmak İstediğinizden emin misiniz?')) return false;" class="fw-bolder text-white-800 text-hover-primary fs-6 btn btn-danger" style="float:right">Çıkış</a>
